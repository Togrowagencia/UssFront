...
export const CrearEmpresaDrawer = ({ openEmpresa, onCloseEmpresa }) => {
    ...
    >
      <div className="w-full h-[5%] flex justify-between items-center">
        <div className="flex items-center gap-[2%] w-[90%]">
          <img src="/svg/sidebar/empresas.svg" alt="" className="w-[4%]" />
          <h4 className="mostaza-suave">Crear/editar Empresa</h4>
        </div>
        <div>
          <img
      ...
      <div className="h-[90%] flex flex-col px-[2%]">
        <div className="w-full flex items-center h-[10%] mt-3">
          ...
          <div className="flex flex-col ml-[10px] gap-2 justify-center w-[80%]">
            ...
            <p className="textos gris-suave">{formData.rut}</p>
          </div>
        </div>
